                ...
                <CarouselContent className="-ml-2 md:-ml-4">
                    ...
                    {result != null && (
                        result.map((product: ProductType) => {
                            const { images = [], productName, price, taste, slug, origin } = product;
                                    ...
                                    <div className="p-1">
                                        <Card className="py-4 border border-gray-200 shadow-none">
                                            <CardContent className="relative flex items-center justify-center px-6 py-2">
                                                <img
                                                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}${firstImage?.url}`}
                                                    alt="image featureds" />
                                                <div className="w-full absolute px-6 transition duration-200 opacity-0 group-hover:opacity-100 bottom-5">
